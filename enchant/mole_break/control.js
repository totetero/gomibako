...
function initController(game, scene, sprite){
	...
	var surface2 = new Surface(64, 64);
	...
	sprite2.x = game.width - 64 - 36;
	sprite2.y = game.height - 64 - 36;
	...
	sprite1.addEventListener('enterframe', function(e){
		...
		// ボタンの描画
		surface2.draw(game.assets['img/btn.png'], 0, 32, 64, 64, 0, 0, 64,  64);
		if(ctrlStruct.k_z){surface2.draw(game.assets['img/btn.png'],  0, 96, 64, 64,  0, 0, 64, 64);}// z押し
	});
	...
	sprite.addEventListener('touchmove', function(e){
		...
		if(ctrlStruct.roth < roth_min){ctrlStruct.roth = roth_min;}
	});
