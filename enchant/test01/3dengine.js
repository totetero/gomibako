...
function pushTriangle(img, modelviewMatrix, vertex1, vertex2, vertex3){
	...
	surface.vert11 = tmpVec1.x / tmpVec1.w;
	surface.vert12 = tmpVec1.y / tmpVec1.w;
	surface.vert21 = tmpVec2.x / tmpVec2.w;
	surface.vert22 = tmpVec2.y / tmpVec2.w;
	surface.vert31 = tmpVec3.x / tmpVec3.w;
	surface.vert32 = tmpVec3.y / tmpVec3.w;
	surface.img = img;
	surface.uv11 = vertex1.u;
	surface.uv12 = vertex1.v;
	surface.uv21 = vertex2.u;
	surface.uv22 = vertex2.v;
	surface.uv31 = vertex3.u;
	surface.uv32 = vertex3.v;
}
...
function get3dSurface(){
	if(surfaceArray_index == surfaceArray_length){
		...
		surface.vert11 = surface.vert12 = 0;
		surface.vert21 = surface.vert22 = 0;
		surface.vert31 = surface.vert32 = 0;
		surface.vert41 = surface.vert42 = 0;
		surface.uv11 = surface.uv12 = 0;
		surface.uv21 = surface.uv22 = 0;
		surface.uv31 = surface.uv32 = 0;
		surface.uv41 = surface.uv42 = 0;
		surface.img = null;
		surface.z = 0;
...
function drawTriangle(g, s){
	var x1 = s.vert21 - s.vert11;
	var y1 = s.vert22 - s.vert12;
	var x3 = s.vert31 - s.vert21;
	var y3 = s.vert32 - s.vert22;
	if(x1 *y3 - y1 * x3 < 0){return;}
	var x2 = s.vert31 - s.vert11;
	var y2 = s.vert32 - s.vert12;
	
	var uv11 = (s.uv21 - s.uv11) * s.img.width;
	var uv12 = (s.uv22 - s.uv12) * s.img.height;
	var uv21 = (s.uv31 - s.uv11) * s.img.width;
	var uv22 = (s.uv32 - s.uv12) * s.img.height;
	...
	var t13 = s.vert11 - (t11 * s.uv11 * s.img.width + t12 * s.uv12 * s.img.height);
	var t23 = s.vert12 - (t21 * s.uv11 * s.img.width + t22 * s.uv12 * s.img.height);
	
	g.save();
	g.beginPath();
	g.moveTo(s.vert11, s.vert12);
	g.lineTo(s.vert21, s.vert22);
	g.lineTo(s.vert31, s.vert32);
	g.clip();
