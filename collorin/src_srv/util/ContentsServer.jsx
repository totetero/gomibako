			...
			switch(req.query["type"] as string){
				case "core":
					list = [
						...
						"/img/system/button/tabLeft/normal.png",
						"/img/system/button/tabLeft/active.png",
						"/img/system/button/tabLeft/select.png",
						"/img/system/button/tabLeft/inactive.png",
						"/img/system/button/tabTop/normal.png",
						"/img/system/button/tabTop/active.png",
						"/img/system/button/tabTop/select.png",
						"/img/system/button/tabTop/inactive.png",
