...
// クエストカートリッジ
class SECquestMain implements SerialEventCartridge{
	var _page : PageQuest;
	var _btnList = {} : Map.<PartsButton>;

	// ----------------------------------------------------------------
	// コンストラクタ
	function constructor(page : PageQuest, response : variant){
		this._page = page;

		// ボタン作成
		this._btnList["test"] = new PartsButtonBasic("クエスト",  20, 70, 200, 40);
	}
