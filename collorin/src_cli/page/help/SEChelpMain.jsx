...
// ヘルプカートリッジ
class SEChelpMain implements SerialEventCartridge{
	var _page : PageHelp;
	var _btnList = {} : Map.<PartsButton>;

	// ----------------------------------------------------------------
	// コンストラクタ
	function constructor(page : PageHelp, response : variant){
		this._page = page;

		// ボタン作成
		this._btnList["test"] = new PartsButtonBasic("ヘルプ",  20, 70, 200, 40);
	}
