...
// 友達カートリッジ
class SECfriendMain implements SerialEventCartridge{
	var _page : PageFriend;
	var _btnList = {} : Map.<PartsButton>;

	// ----------------------------------------------------------------
	// コンストラクタ
	function constructor(page : PageFriend, response : variant){
		this._page = page;

		// ボタン作成
		this._btnList["test"] = new PartsButtonBasic("友達",  20, 70, 200, 40);
	}
