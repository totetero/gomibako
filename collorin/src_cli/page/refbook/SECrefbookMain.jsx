...
// 図鑑カートリッジ
class SECrefbookMain implements SerialEventCartridge{
	var _page : PageRefbook;
	var _btnList = {} : Map.<PartsButton>;

	// ----------------------------------------------------------------
	// コンストラクタ
	function constructor(page : PageRefbook, response : variant){
		this._page = page;

		// ボタン作成
		this._btnList["test"] = new PartsButtonBasic("図鑑",  20, 70, 200, 40);
	}
