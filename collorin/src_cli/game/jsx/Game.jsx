...
class Player{
	...
	function constructor(){
		var parts = '{"img":"pdot","dat":{"head":[[0,0,0,0,0,16,0],[-0.06,0.20,-0.02,0,48,16,0],[-0.06,-0.20,-0.02,0,48,16,1],[-0.19,0,-0.09,0,64,16,0]],"body":[[0,0,0,0,16,16,0]],"ftr1":[[0,0,0,0,32,8,0]],"ftl1":[[0,0,0,0,32,8,1]],"ftr2":[[0,0,0,32,32,8,0]],"ftl2":[[0,0,0,32,32,8,1]],"hndr":[[0,0,0,0,40,8,0]],"hndl":[[0,0,0,0,40,8,1]]}}';
		...
		this.character = new DrawPlayer(parts, pose);
